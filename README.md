...
- **Game library support** — the picker lists installed games from Steam, Epic, GOG, EA, Ubisoft, Rockstar, Battle.net, Riot, Amazon and other launchers (library folders + Start Menu + **desktop shortcuts**), even when the games aren't running; launchers themselves can be added too, and duplicate shortcuts merge into one entry
